  ...
  tabItem(
    ...
    div(
      ...
      fluidRow(
        ...
        box(
          width = 4,
          title = paste(title, "- 15% Risk"),
          plotOutput(scatter15_id, height = 400)
        ),
        
        box(
          width = 4,
          title = paste(title, "- 30% Risk"),
          plotOutput(scatter30_id, height = 400)
        ),
        
        box(
          width = 4,
          title = paste(title, "- 80% Risk"),
          plotOutput(scatter80_id, height = 400)
        )
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      event_horizon_tab(
        ...
        "current-theme",
        "current7_event_map",
        "current7_event_scatter15",
        "current7_event_scatter30",
        "current7_event_scatter80"
      ),
      ...
      event_horizon_tab(
        ...
        "current-theme",
        "current30_event_map",
        "current30_event_scatter15",
        "current30_event_scatter30",
        "current30_event_scatter80"
      ),
      ...
      event_horizon_tab(
        ...
        "forecast-theme",
        "forecast7_event_map",
        "forecast7_event_scatter15",
        "forecast7_event_scatter30",
        "forecast7_event_scatter80"
      ),
