...
server <- function(input, output, session) {
  ...
  event_horizon_baseline <- read_csv(
    "../STN_EMULATOR/eventhorizon_baseline.csv",
  ...
  print("EVENT HORIZON FILE LOADED")
  print(dim(event_horizon_baseline))
  print(names(event_horizon_baseline))
  # -----------------------------
